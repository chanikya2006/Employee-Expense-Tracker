...
export class LoginComponent implements OnInit {
  ...
  constructor(
    ...
    this.activateroute.queryParams.subscribe((p) => {
      ...
      if (
        (p['email'] != undefined || p['email'] != null) &&
        (p['pass'] != undefined || p['pass'] != null)
      ) {
  ...
  ngOnInit(): void {
    ...
    if (
      this.queryEmail != undefined &&
      this.queryPass != undefined
    ) {

      if (this.queryEmail == 'abc@gmail.com') {

        this.msg = "Please Wait.. Login Admin Account";
  ...
  onLogin(wayToLogin: string) {
    ...
    if (wayToLogin == 'autoLogin') {
      ...
      this.loginForm.setValue({
        ...
        gmail: this.queryEmail,

        password: this.queryPass
